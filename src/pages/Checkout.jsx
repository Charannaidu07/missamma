        ...
        handler: async function (response) {
          try {
            ...
            if (verifyRes.data.status === "success") {
              ...
              const invoiceUrl = `https://missammabackend.onrender.com/api/payments/invoice/${order_id}/?token=${token}`;
  ...
  const handleWalletPay = async () => {
    ...
    try {
      ...
      if (res.data.status === "success") {
        ...
        // Open invoice in new tab
        const token = localStorage.getItem("access");
        const invoiceUrl = `https://missammabackend.onrender.com/api/payments/invoice/${res.data.order_id}/?token=${token}`;
        window.open(invoiceUrl, "_blank");
      ...
      const msg = err.response?.data?.detail || "Wallet payment failed. Check login / wallet balance.";
      alert(msg);
    } finally {
      setLoading(false);
    }
