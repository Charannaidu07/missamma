    ...
    <div className="card">
      ...
      {!activeCategory && (
        <div style={{ margin: '1.5rem 0' }}>
          <h3 style={{ fontSize: '1.1rem', marginBottom: '0.8rem' }}>Service Categories</h3>
          <div style={{
            display: 'flex',
            gap: '0.5rem',
            flexWrap: 'wrap'
      ...
      >
        {filteredServices.length > 0 ? (
          ...
          <div style={{ 
            ...
            {activeCategory ? (
              <div>
                <h3>No services found in {activeCategory}</h3>
                <p>Please check back later or browse our other service categories.</p>
                <Link 
                  to="/services" 
                  style={{
                    color: '#e84393',
      ...
      {!activeCategory && filteredServices.length > 0 && (
        <div style={{
          ...
          <h3 style={{ marginBottom: '0.5rem' }}>Ready to Book?</h3>
